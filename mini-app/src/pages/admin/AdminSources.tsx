    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold tracking-tight">Источники</h1>
          <button
      ...
      <ConfirmDialog
        ...
        message={`Вы уверены, что хотите удалить источник "${deleteTarget?.title}"? Это действие нельзя отменить.`}
        confirmText="Удалить"
        variant="danger"
      />
    </AdminLayout>
