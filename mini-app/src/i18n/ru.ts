...
const ru: Record<TranslationKey, string> = {
  ...
  "legal.terms.updated": "Обновлено: март 2026",
  "legal.terms.intro": "Используя izEscrowAI, вы соглашаетесь с этими условиями. Это хакатон-демо, а не финансовый сервис.",
  "legal.terms.service.title": "1. Описание сервиса",
  "legal.terms.service.text": "izEscrowAI — AI-маркетплейс для фрилансеров на блокчейне TON. Платформа обеспечивает эскроу-сделки между сторонами через смарт-контракты.",
  "legal.terms.custody.title": "2. Non-custodial принцип",
  "legal.terms.custody.text": "izEscrowAI не хранит ваши средства. Деньги находятся в индивидуальных смарт-контрактах на Tolk (TON). Бот выступает арбитром, но никогда не владеет средствами. Вы несёте полную ответственность за безопасность своего кошелька.",
  "legal.terms.ai.title": "3. AI-функции",
  "legal.terms.ai.text": "AI-функции (парсинг сделок, генерация спецификаций, оценка цен, подбор, оценка рисков, медиация споров) носят рекомендательный характер. AI может ошибаться. Окончательные решения о сделках, ценах и спорах принимают пользователи.",
  "legal.terms.fees.title": "4. Комиссия",
  "legal.terms.fees.text": "Прозрачная комиссия 1% удерживается on-chain смарт-контрактом при завершении сделки (подтверждение, разрешение спора или таймаут). Комиссия поступает на кошелёк платформы. При отмене покупатель получает полный возврат без комиссии.",
  "legal.terms.user.title": "5. Ответственность пользователя",
  "legal.terms.user.text": "Вы несёте ответственность за: точность описания сделок, сохранность данных кошелька, соблюдение местного законодательства о P2P-транзакциях и проверку контрагента перед отправкой средств.",
  "legal.terms.ip.title": "6. Интеллектуальная собственность",
  "legal.terms.ip.text": "izEscrowAI — open source под лицензией AGPL-3.0. AI-промпты и алгоритмы скоринга защищены той же лицензией. При запуске модифицированной версии как сервиса вы обязаны опубликовать исходный код.",
  "legal.terms.disclaimer.title": "7. Отказ от ответственности",
  "legal.terms.disclaimer.text": "Платформа предоставляется «как есть» без каких-либо гарантий. Мы не несём ответственности за: баги смарт-контрактов, проблемы сети блокчейна, ошибки AI, потерю средств по вине пользователя, споры между пользователями. Это не финансовая консультация.",
  "legal.terms.contact.title": "8. Контакт",
  "legal.terms.contact.text": "Вопросы: @izEscrowAIBot в Telegram или github.com/izzzzzi/izEscrowAI",

  // Legal — Privacy Policy
  "legal.privacy.title": "Политика конфиденциальности",
  "legal.privacy.updated": "Обновлено: март 2026",
  "legal.privacy.intro": "Эта политика описывает, как izEscrowAI собирает, использует и защищает ваши данные.",
  "legal.privacy.collect.title": "1. Какие данные мы собираем",
  "legal.privacy.collect.telegram": "Telegram: ID пользователя, юзернейм, имя, фото (через Telegram Login Widget или Mini App)",
  "legal.privacy.collect.wallet": "Кошелёк: адрес TON-кошелька (через TON Connect)",
  "legal.privacy.collect.github": "GitHub: данные профиля, репозитории, языки, звёзды, коммиты, организации (через OAuth)",
  "legal.privacy.collect.deals": "Сделки: описания, суммы, статусы, доказательства в спорах",
  "legal.privacy.collect.jobs": "Заказы: парсятся из публичных Telegram-групп (названия, бюджеты, навыки)",
  "legal.privacy.collect.technical": "Техническое: IP-адрес для rate limiting (не сохраняется)",
  "legal.privacy.purpose.title": "2. Как мы используем данные",
  "legal.privacy.purpose.text": "Данные используются для: обеспечения эскроу-сделок, расчёта Trust Score, подбора по навыкам, генерации AI-предложений, верификации через GitHub и предотвращения злоупотреблений.",
  "legal.privacy.storage.title": "3. Хранение данных",
  "legal.privacy.storage.text": "Данные хранятся в PostgreSQL на Railway. GitHub OAuth-токены хранятся для получения профиля. Мы не продаём и не передаём ваши данные третьим лицам в маркетинговых целях.",
  "legal.privacy.third.title": "4. Сторонние сервисы",
  "legal.privacy.third.text": "Мы используем: OpenRouter (AI-обработка — описания сделок и заказов отправляются для анализа), TON blockchain (публичные транзакции), GitHub API (верификация профиля), Telegram API (аутентификация).",
  "legal.privacy.rights.title": "5. Ваши права",
  "legal.privacy.rights.text": "Вы можете: отвязать GitHub-аккаунт в любой момент, запросить удаление данных, просмотреть разбор Trust Score в профиле. Транзакции на блокчейне необратимы и не могут быть удалены.",
  "legal.privacy.changes.title": "6. Изменения",
  "legal.privacy.changes.text": "Мы можем обновлять эту политику. Продолжение использования после изменений означает согласие.",
